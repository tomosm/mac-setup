...
# Install libs/servers
brew install cmake mhash colordiff msgpack curl dnsmasq nkf freetype oniguruma gdbm openssl geoip pcre gettext peco git phantomjs git-flow-avh pkg-config gnu-getopt pwgen groonga readline htop rename icu4c tree wget intltool xz jpeg jq libmaxminddb libpng libtiff libtool libxml2 libzip mcrypt mecab mysql mecab-ipadic media-info tmux jpegoptim optipng postgres graphviz reattach-to-user-namespace ack watch htop-osx pstree ffmpeg yarn redis protobuf
brew install autoconf autojump automake  libevent libiconv libmpc08 libpng12 libxslt memcached qt git-lfs nmap heroku hub pngquant mozjpeg
# imagemagick python
...
# Install apps
brew cask install appcleaner google-drive unetbootin caffeine google-japanese-ime kindle vagrant charles grammarly kitematic virtualbox cyberduck handbrake macdown vitalsource-bookshelf docker hex-fiend navicat-for-mysql wireshark dropbox hipchat scroll-reverser zoomus firefox importio flux intellij-idea sequel-pro github-desktop iterm2 skype google-chrome java sublime-text microsoft-office dashlane robomongo fantastical kotori macs-fan-control clipy anydesk ngrok sketch kap boostnote postman totalspaces megasync karabiner-elements
# brew cask install hyperswitch karabiner seil zulip
...
# 1278508951 Trello (2.9.7)
mas install 514951692 539883307 406056744 441258766 510620098 425424353 501816915 425955336 973213640 497799835 406827163 508368068 402835630 405843582 803453959 529763712 475260933 533978766 973134470 980577198 507135296 1278508951
